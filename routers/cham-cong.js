...
router.put("/events/:id", async (req, res, next) => {
    ...
    try {
        ...
        const ngayLam = await NgayLam.findById(id);
        ngayLam.gioBuoiSang = gioBuoiSang;
        ngayLam.gioBuoiChieu = gioBuoiChieu;
        ngayLam.gioLamThem = gioLamThem;
        ngayLam.tongGio = tongGio;
